...
**Keywords**
Glycerolipids, natural variation, developmental stages,ultra high performance liquid chromatography, quadrupole time of flight mass spectrometry
...
![FigureX](https://github.com/rrlab/zea_lip_base/blob/master/output/3Genotypes_sum_lipid_classes_heatmap_lipid_class_average.png)**FigureX: Lipid class average per genotype**
